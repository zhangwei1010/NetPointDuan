...
public class DispatchedFragment extends BaseFragment {
    ...
    private void loadData() {
        ...
        showProgressDialog();
        model.getDispatchedOrder(SpUtils.getIncNumber(), pageSize, pageNum + "", e -> {
                    e.printStackTrace();
                    hideProgressDialog();
                    hideRefresh();
                    hasMore = false;
    ...
    private DispatchedAdapter mAdapter = new DispatchedAdapter();
